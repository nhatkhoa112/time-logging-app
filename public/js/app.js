...
class TimersDashboard extends React.Component {
    ...
    componentDidMount() {
        ...
        setInterval(this.loadTimersFromServer, 5000); // 5 seconds
    };

    // Passing 'getTimers()' a success function
    loadTimersFromServer = () => {
        client.getTimers((serverTime) => {
            this.setState({timers: serverTime})
        });
    };
    ...
    // Define these functions for Start and Stop
        ...
        this.setState({
            timers:this.state.timers.map((timer) => {
                if(timer.id === timerId) {
                    ...
                    console.log(now, timer.runningSince);
                    return Object.assign({}, timer, {
    ...
    render() {
        const timers = this.props.timers.map((timer) => (
            <EditableTimer 
                ...
                // Pass this props to upper components
...
class Timer extends React.Component {
    // Add forceUpdate() interval to Timer
    ...
    // Handle for start and stop 
    handleStartClick = () => {
        console.log(this.props.onStartClick(this.props.id));
